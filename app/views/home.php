...
<div class="container">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="container px-4 " id="featured-3" ng-controller="danhmucHome">
          <h2 class="pb-2 border-bottom" style="text-align: center;">DANH MỤC ACC GAME</h2>
          <div class="row g-4 py-5 row-cols-1 row-cols-lg-4">
            <div ng-repeat="danhmuc in danhmucs" class = "row card category" style="padding: 0px;">
              <div class = "card-body" style="padding: 0px;">
                  <img class="img-fluid" src="/assets/img/{{danhmuc.hinhdm}}" style="border-radius:5px 5px 0px 0px"/>
                  <div class="container text-center" style="padding-left: 0px;">
                    <div class="row">
                      <div class="col">{{danhmuc.tendm}}</div>
                    </div>
                  </div> 
                  <div class="container text-center" style="padding-left: 0px;">
                    <div class="row">
                      <button type="button" class="btn btn-primary"><a href="sanpham?danhmuc={{danhmuc.id}}" style="color:white;text-decoration:none;">Mua ngay</a></button>
                    </div>
                  </div> 
              </div>
            </div>
